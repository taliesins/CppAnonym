...
#define URASANDESU_CPPANONYM_METADATA_BASEMETHODBODYWRITER_HPP
...
namespace Urasandesu { namespace CppAnonym { namespace Metadata {
    ...
    struct MethodBodyWriterApiAt : 
        Traits::ApiAt<ApiCartridgesHolder, Interfaces::MethodBodyWriterApiHolderLabel, ApiLabel>
    {
    };
...
#endif  // #ifndef URASANDESU_CPPANONYM_METADATA_BASEMETHODBODYWRITER_HPP