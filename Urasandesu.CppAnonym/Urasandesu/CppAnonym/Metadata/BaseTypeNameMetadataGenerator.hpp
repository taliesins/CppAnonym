...
namespace Urasandesu { namespace CppAnonym { namespace Metadata {
    ...
    //    Traits::HashComputable<BaseTypeNameMetadataGenerator<TypeNameMetadataGeneratorApiHolder> const *>
    //{
    //public:
    //    typedef typename TypeNameMetadataGeneratorApiAt<TypeNameMetadataGeneratorApiHolder, Interfaces::ModuleNameMetadataGeneratorLabel>::type module_name_metadata_generator_type;
    ...
    //    Traits::EqualityComparable<BaseTypeNameMetadataGenerator<TypeNameMetadataGeneratorApiHolder> const *>
    //{
    //public:
    //    typedef typename TypeNameMetadataGeneratorApiAt<TypeNameMetadataGeneratorApiHolder, Interfaces::ModuleNameMetadataGeneratorLabel>::type module_name_metadata_generator_type;
