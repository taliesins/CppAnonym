...
namespace Urasandesu { namespace CppAnonym { namespace Metadata {
    ...
    //    Traits::HashComputable<BaseFieldNameMetadataGenerator<FieldNameMetadataGeneratorApiHolder> const *>
    //{
    //public:
    //    typedef typename FieldNameMetadataGeneratorApiAt<FieldNameMetadataGeneratorApiHolder, Interfaces::TypeNameMetadataGeneratorLabel>::type type_name_metadata_generator_type;
    ...
    //    Traits::EqualityComparable<BaseFieldNameMetadataGenerator<FieldNameMetadataGeneratorApiHolder> const *>
    //{
    //public:
    //    typedef typename FieldNameMetadataGeneratorApiAt<FieldNameMetadataGeneratorApiHolder, Interfaces::TypeNameMetadataGeneratorLabel>::type type_name_metadata_generator_type;
