...
namespace Urasandesu { namespace CppAnonym { namespace Metadata {
    ...
    class BaseMetadataDispenserProtoB8DF5A21 :
        public HeapProvider<
            mdToken, 
            boost::mpl::vector<
                BaseAssemblyMetadataProtoB8DF5A21<typename MetadataDispenserApiType::assembly_metadata_api_type> 
            >
        >
    {
    public:
        typedef BaseMetadataDispenserProtoB8DF5A21<MetadataDispenserApiType> this_type;
        typedef BaseMetadataInfoProtoB8DF5A21<
                    typename MetadataDispenserApiType::metadata_info_api_type> metadata_info_type;
        typedef BaseAssemblyMetadataProtoB8DF5A21<
                    typename MetadataDispenserApiType::assembly_metadata_api_type> assembly_metadata_type;
