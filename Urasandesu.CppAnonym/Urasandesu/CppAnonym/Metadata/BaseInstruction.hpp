...
#define URASANDESU_CPPANONYM_METADATA_BASEINSTRUCTION_HPP
...
namespace Urasandesu { namespace CppAnonym { namespace Metadata {
    ...
    struct InstructionApiAt : 
        Traits::ApiAt<ApiCartridgesHolder, Interfaces::InstructionApiHolderLabel, ApiLabel>
    {
    };
...
#endif  // #ifndef URASANDESU_CPPANONYM_METADATA_BASEINSTRUCTION_HPP